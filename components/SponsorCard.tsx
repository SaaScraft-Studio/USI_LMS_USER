...
export default function SponsorCard() {
  return (
    <div className="h-48 rounded-2xl bg-white p-6 text-center shadow-lg ring-1 ring-gray-200 flex flex-col justify-center">
      <p className="mb-4 text-[11px] font-semibold tracking-widest text-gray-500">
